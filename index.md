...
- **Runtime Governance vs. Development Governance**
  ...
  - **Venue**: *SSRN*
  - **Artifacts**: 
    - [Draft Manuscript](manuscripts/2026-01_runtime-governance-vs-development-governance_v1.0.md)
    - [Submitted Version](in-progress/2026-01_runtime-governance-vs-development-governance.pdf)
    - [Version History](history/2026-01_runtime-governance-vs-development-governance.history.md)
...
- **Realizing ISO/IEC 42001 through Decision Behavior Governance**
  ...
  - **Venue**: *SSRN*
  - **Artifacts**: 
    - [Draft Manuscript](manuscripts/2026-01_realizing-ISO-IEC-42001-through-decision-behavior-governance_v1.0.md)
    - [Submitted Version](in-progress/2026-01_realizing-ISO-IEC-42001-through-decision-behavior-governance.pdf)
    - [Version History](history/2026-01_realizing-ISO-IEC-42001-through-decision-behavior-governance.history.md)
...
- **Ghost Intent: An Effect of Traceability Collapse in GenAI-Assisted SDLCs**
  ...
  - **Venue**: *SSRN*
  - **Artifacts**: 
    - [Draft Manuscript](manuscripts/2026-02_ghost-intent-authorless-traceability-collapse_v1.0.md)
    - [Submitted Version](in-progress/2026-02_ghost-intent-authorless-traceability-collapse.pdf)
    - [Version History](history/2026-02_ghost-intent-authorless-traceability-collapse.history.md)

- **Inference Creep: Decision Expansion and Governance Drift in AI-Assisted Software Engineering**
  - **Status**:  `Draft`
  - **Venue**: *arXiv*
  - **Artifacts**: 
    - [Draft Manuscript](manuscripts/2026-02_inference-creep-decision-expansion-and-governance-drift_0.6.md)
    - [Version History](history/2026-02_inference-creep-decision-expansion-and-governance-drift.history.md)

### Decision Behavior Definitions
...
- **Boundary as an Execution-Time Primitive for AI-Assisted Software Development Governance**
  ...
  - **Venue**: *arXiv*
  - **Artifacts**: 
    - [Draft Manuscript](manuscripts/2026-02_boundary-as-an-execution-time-primitive-v1.0.md)
    - [Submitted Version](in-progress/2026-02_boundary-as-an-execution-time-primitive.tex)
    - [Version History](history/2026-02_boundary-as-an-execution-time-primitive.history.md)
